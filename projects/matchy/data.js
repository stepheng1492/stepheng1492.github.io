 ...
 */
 ...
 // 1) Dot notation for when you know exactly the name of the key you're referencing,
 //    Bracket notation for when you want to access keys dynamically
 
 // 2) You can only access arrays using bracket notation
...
//Im choosing an array, since they're best used for lists that have no particular order and aren't associated with certain properties

friends = [];
getRandom = (array) => Math.floor(Math.random() * Math.floor(array.length));
